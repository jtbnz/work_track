...
$statuses = array_filter($statuses, function($status) use ($settingsModel) {
    // Check individual status visibility setting (default is visible)
    return $settingsModel->get('kanban_status_visible_' . $status['id'], '1') === '1';
});
